...
namespace Hedera.Hashgraph.Tests.Integration.Contract
{
    ...
    public class ContractDeleteIntegrationTest
    {
        ...
        [Fact]
        /// <include file="ContractDeleteIntegrationTest.cs.xml" path='docs/member[@name="M:Hedera.Hashgraph.Tests.Integration.ContractDeleteIntegrationTest.CanDeleteContractWithAdminKey"]' />
        ...
        [Fact]
        /// <include file="ContractDeleteIntegrationTest.cs.xml" path='docs/member[@name="M:Hedera.Hashgraph.Tests.Integration.ContractDeleteIntegrationTest.CannotDeleteContractWhichHasNoAdminKey"]' />
        ...
        [Fact]
        /// <include file="ContractDeleteIntegrationTest.cs.xml" path='docs/member[@name="M:Hedera.Hashgraph.Tests.Integration.ContractDeleteIntegrationTest.CannotDeleteContractWhenContractIDIsNotSet"]' />
