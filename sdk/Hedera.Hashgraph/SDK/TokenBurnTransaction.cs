 ...
 */
     ...
     */
	TokenBurnTransaction(Proto.TransactionBody txBody)
	{
		super(txBody);
		initFromTransactionBody();
	}
     ...
     * @return {@code this}
     */
	public TokenBurnTransaction setAmount(LongNN amount)
	{
		requireNotFrozen();
		this.amount = amount;
		return this;
     ...
     * @return {@code this}
     */
	public TokenBurnTransaction addSerial(LongNN serial)
	{
		requireNotFrozen();
		serials.Add(serial);
		return this;
     ...
     *
     * @return {@link Proto.TokenBurnTransactionBody}
     */
