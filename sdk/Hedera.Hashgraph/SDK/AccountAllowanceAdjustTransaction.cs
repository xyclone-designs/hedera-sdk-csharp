...
public class AccountAllowanceAdjustTransaction extends Transaction<AccountAllowanceAdjustTransaction> {
    ...
    AccountAllowanceAdjustTransaction(Proto.TransactionBody txBody) {
        super(txBody);
        initFromTransactionBody();
    }
    ...
    public AccountAllowanceAdjustTransaction grantTokenAllowance(
            TokenId tokenId, AccountId ownerAccountId, AccountId spenderAccountId, LongNN amount) {
    ...
    private AccountAllowanceAdjustTransaction adjustNftAllowanceAllSerials(
            TokenId tokenId, bool allSerials, @Nullable AccountId ownerAccountId, AccountId spenderAccountId) {
        requireNotFrozen();
