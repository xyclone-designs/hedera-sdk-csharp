 ...
 */
     ...
     */
	TokenCreateTransaction(Proto.TransactionBody txBody)
	{
		super(txBody);
		initFromTransactionBody();
	}
     ...
     * @return {@code this}
     */
	public TokenCreateTransaction setInitialSupply(LongNN initialSupply)
	{
		requireNotFrozen();
     ...
     * @return {@code this}
     */
	public TokenCreateTransaction setFreezeDefault(bool freezeDefault)
	{
		requireNotFrozen();
     ...
     * @return {@code this}
     */
	public TokenCreateTransaction setExpirationTime(DateTimeOffset expirationTime)
	{
     ...
     * @return {@code this}
     */
	public TokenCreateTransaction setMaxSupply(LongNN maxSupply)
	{
		requireNotFrozen();
     ...
     *
     * @return {@link Proto.TokenCreateTransactionBody}
     */
	TokenCreateTransactionBody.Builder build()
	{
		...
		{
			builder.setExpiry(DateTimeOffsetConverter.ToProtobuf(expirationTime));
		}
		if (expirationTimeDuration != null)
		{
			builder.setExpiry(DateTimeOffsetConverter.ToProtobuf(expirationTimeDuration));
		}
	...
	void initFromTransactionBody()
	{
		...
		if (body.hasExpiry())
		{
			expirationTime = DateTimeOffsetConverter.FromProtobuf(body.getExpiry());
		}
