 ...
 */
	public sealed class ContractUpdateTransaction : Transaction<ContractUpdateTransaction> 
	{
		 ...
		 */
		ContractUpdateTransaction(Proto.TransactionBody txBody)
		{
			super(txBody);
			initFromTransactionBody();
		}
		 ...
		 *
		 * @param expirationTime The DateTimeOffset to be set for expiration time
		 * @return {@code this}
		 */
		public ContractUpdateTransaction setExpirationTime(DateTimeOffset expirationTime)
		{
		 ...
		 *
		 * @return {@link Proto.ContractUpdateTransactionBody builder }
		 */
