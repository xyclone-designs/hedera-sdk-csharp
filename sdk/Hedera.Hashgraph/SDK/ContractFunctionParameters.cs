namespace Hedera.Hashgraph.SDK
{
	...
	public sealed class ContractFunctionParameters
	{
		 ...
		 */
		public static readonly int ADDRESS_LEN = EntityIdHelper.SOLIDITY_ADDRESS_LEN;

		/**
		 * The length of a hexadecimal-encoded Solidity address, in ASCII characters (bytes).
		 */
		public static readonly int ADDRESS_LEN_HEX = EntityIdHelper.SOLIDITY_ADDRESS_LEN_HEX;
    ...
    private readonly ArrayList<Argument> args = new ArrayList<>();
