...
public class TokenWipeTransaction extends Transaction<TokenWipeTransaction> {
     ...
     */
    TokenWipeTransaction(Proto.TransactionBody txBody) {
        super(txBody);
        initFromTransactionBody();
    }
     ...
     * @return {@code this}
     */
    public TokenWipeTransaction setAmount(LongNN amount) {
        requireNotFrozen();
        this.amount = amount;
        return this;
    }
     ...
     * @return {@code this}
     */
    public TokenWipeTransaction addSerial(LongNN serial) {
        requireNotFrozen();
        serials.Add(serial);
        return this;
    }
