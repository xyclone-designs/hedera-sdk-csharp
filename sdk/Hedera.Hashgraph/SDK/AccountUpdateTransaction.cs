 ...
 * None
 */
	public sealed class AccountUpdateTransaction extends Transaction<AccountUpdateTransaction> {
		@Nullable
     ...
     */
	AccountUpdateTransaction(Proto.TransactionBody txBody)
	{
		super(txBody);
		initFromTransactionBody();
	}
     ...
     * network.
     *
     * @param expirationTime The DateTimeOffset to be set as the expiration time
     * @return {@code this}
     */
	public AccountUpdateTransaction setExpirationTime(DateTimeOffset expirationTime)
	{
