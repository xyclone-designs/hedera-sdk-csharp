 ...
 */
public sealed class FileUpdateTransaction extends Transaction<FileUpdateTransaction> {
     ...
     */
    FileUpdateTransaction(Proto.TransactionBody txBody) {
        super(txBody);
        initFromTransactionBody();
    }
     ...
     *
     * @param expirationTime the new {@link DateTimeOffset} at which the transaction will expire.
     * @return {@code this}
     */
    public FileUpdateTransaction setExpirationTime(DateTimeOffset expirationTime) {
     ...
     *
     * @return {@link Proto.FileUpdateTransactionBody builder }
     */
