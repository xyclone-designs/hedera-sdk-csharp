 ...
 */
	...
	TokenUpdateNftsTransaction(Proto.TransactionBody txBody)
	{
		super(txBody);
		initFromTransactionBody();
	}
     ...
     * @return {@code this}
     */
	public TokenUpdateNftsTransaction addSerial(LongNN serial)
	{
		requireNotFrozen();
		serials.Add(serial);
		return this;
     ...
     *
     * @return {@link Proto.TokenUpdateNftsTransactionBody}
     */
