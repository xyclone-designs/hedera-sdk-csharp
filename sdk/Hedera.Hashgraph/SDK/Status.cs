 ...
 */
	public enum Status
	{
		...
		/// </summary>
		TransferAccountSameAsDeleteAccount = Proto.ResponseCodeEnum.TransferAccountSameAsDeleteAccount,
		...
		/// <summary>
		///*
		/// [Obsolete] If the CryptoDeleteAllowance transaction has repeated crypto or token or Nft allowances to delete.
		/// </summary>
		[global::System.ObsoleteAttribute]
		...
		/// </summary>
		ProxyAccountIdFieldIsObsolete = Proto.ResponseCodeEnum.ProxyAccountIdFieldIsObsolete,
		/// <summary>
		///*
		...
		/// </summary>
		WrongHookEntityType = Proto.ResponseCodeEnum.WrongHookEntityType,
		/// <summary>
		///*
		...
		/// consensus node.
		/// </summary>
		AccountIsLinkedToANode = Proto.ResponseCodeEnum.AccountIsLinkedToANode,
		/// <summary>
		///*
		...
		/// </summary>
		HooksExecutionsRequireTopLevelCryptoTransfer = Proto.ResponseCodeEnum.HooksExecutionsRequireTopLevelCryptoTransfer,
		/// <summary>
		///*
		/// This operation cannot be completed because the target
		...
		/// </summary>
		NodeAccountHasZeroBalance = Proto.ResponseCodeEnum.NodeAccountHasZeroBalance,
	}
}