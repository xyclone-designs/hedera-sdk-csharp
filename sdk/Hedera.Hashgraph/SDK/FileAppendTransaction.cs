 ...
 * correct, then update the file entry with any readonly metadata changes (e.g.
 ...
 * None
 */
public sealed class FileAppendTransaction extends ChunkedTransaction<FileAppendTransaction> {
     ...
     */
    FileAppendTransaction(Proto.TransactionBody txBody) {
        super(txBody);
        initFromTransactionBody();
    }
     ...
     *
     * @return {@link Proto.FileAppendTransactionBody builder}
     */
