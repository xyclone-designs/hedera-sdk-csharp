 ...
 * schedule created.
 */
	public sealed class ScheduleCreateTransaction extends Transaction<ScheduleCreateTransaction> {
		@Nullable
     ...
     * @return {@code this}
     */
	public ScheduleCreateTransaction setExpirationTime(DateTimeOffset expirationTime)
	{
     ...
     *
     * @return {@link Proto.ScheduleCreateTransactionBody builder }
     */
