 ...
 */
     ...
     */
	NodeCreateTransaction(Proto.TransactionBody txBody)
	{
		super(txBody);
		initFromTransactionBody();
	}
     ...
     * @return {@code this}
     */
	public NodeCreateTransaction setDeclineReward(bool decline)
	{
		requireNotFrozen();
     ...
     *
     * @return {@link Proto.NodeCreateTransactionBody}
     */
	NodeCreateTransactionBody.Builder build()
	{
		...
		{
			bool hasFqdn = gossipEndpoint.getDomainName() != null
