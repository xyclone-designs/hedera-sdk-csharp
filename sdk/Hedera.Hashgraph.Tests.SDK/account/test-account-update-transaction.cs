...
{
    /// <include file="test-account-update-transaction.ts.cs.xml" path='docs/member[@name="T:Hedera.Hashgraph.Tests.SDK.Account.AccountUpdateTransactionTest"]' />
    public class AccountUpdateTransactionTest
    {
        ...
        [Fact]
        /// <include file="test-account-update-transaction.ts.cs.xml" path='docs/member[@name="M:Hedera.Hashgraph.Tests.SDK.Account.AccountUpdateTransactionTest.ShouldBytes"]' />
        ...
        [Fact]
        /// <include file="test-account-update-transaction.ts.cs.xml" path='docs/member[@name="M:Hedera.Hashgraph.Tests.SDK.Account.AccountUpdateTransactionTest.ShouldBytesNoSetters"]' />
        ...
        [Fact]
        /// <include file="test-account-update-transaction.ts.cs.xml" path='docs/member[@name="M:Hedera.Hashgraph.Tests.SDK.Account.AccountUpdateTransactionTest.ShouldBytes2"]' />
        ...
        [Fact]
        /// <include file="test-account-update-transaction.ts.cs.xml" path='docs/member[@name="M:Hedera.Hashgraph.Tests.SDK.Account.AccountUpdateTransactionTest.FromScheduledTransaction"]' />
