...
namespace Hedera.Hashgraph.Examples
{
    ...
    public class MultiSigOfflineExample
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine("Alice signed the transaction. Signature: " + Arrays.ToString(alicesSignature));
            byte[] bobsSignature = bobPrivateKey.SignTransaction(Transaction.FromBytes(transactionBytes));
            Console.WriteLine("Bob signed the transaction. Signature: " + Arrays.ToString(bobsSignature));
            /// <summary>
            /// Step 5:
