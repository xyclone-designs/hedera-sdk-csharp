...
namespace Hedera.Hashgraph.Tests.SDK.Networking
{
    public class BaseNodeAddressTest
    {
        public virtual void FromString()
        {
            ...
            Assert.Equal(ipAddress.Port, BaseNodeAddress.PORT_NODE_PLAIN);
            ...
            Assert.Equal(ipAddressSecure.Port, BaseNodeAddress.PORT_NODE_TLS);
            ...
            Assert.Equal(ipAddressInsecure.Port, BaseNodeAddress.PORT_NODE_PLAIN);
            ...
            Assert.Equal(urlAddress.Port, BaseNodeAddress.PORT_NODE_PLAIN);
            ...
            Assert.Equal(urlAddressSecure.Port, BaseNodeAddress.PORT_NODE_TLS);
            ...
            Assert.Equal(urlAddressInsecure.Port, BaseNodeAddress.PORT_NODE_PLAIN);
            ...
            Assert.Equal(mirrorNodeAddress.Port, BaseNodeAddress.PORT_MIRROR_TLS);
            ...
            Assert.Equal(mirrorNodeAddressSecure.Port, BaseNodeAddress.PORT_MIRROR_TLS);
            Assert.Equal(mirrorNodeAddressSecure.ToString(), "mainnet-public.mirrornode.hedera.com:443");
            InvalidOperationException exception1 = Assert.Throws<InvalidOperationException>(() => BaseNodeAddress.FromString("this is a random string with spaces:443"));
            InvalidOperationException exception2 = Assert.Throws<InvalidOperationException>(() => BaseNodeAddress.FromString("mainnet-public.mirrornode.hedera.com:notarealport"));
        }
    }
}