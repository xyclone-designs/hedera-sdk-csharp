...
namespace Hedera.Hashgraph.Tests.SDK
{
    public class HederaTrustManagerTest
    {
        ...
        public static readonly byte[] PREVIEWNET_CERT_NODE_3_BYTES = Encoding.UTF8.GetBytes(PREVIEWNET_CERT_NODE_3_STRING);
        public static readonly X509Certificate PREVIEWNET_CERT_NODE_3;
        static HederaTrustManagerTest()
        {
            try
            {
                PREVIEWNET_CERT_NODE_3 = X509CertificateLoader.LoadCertificate(PREVIEWNET_CERT_NODE_3_BYTES);
            }
        ...
        public virtual void ProperlyChecksCertificateAgainstCurrentNetworkAddressBook()
        {
            ...
            //new HederaTrustManager(client.Network_.CertHash, client.VerifyCertificates).CheckServerTrusted(CERTIFICATE_CHAIN, "");
        }
        ...
        public virtual void CertificateCheckFailWhenHashMismatches()
        {
            ...
            Assert.Throws<CertificateException>(() => 
            {
                //new HederaTrustManager(client.Network_.Network .CertHash, client.VerifyCertificates).CheckServerTrusted(CERTIFICATE_CHAIN, "");
            });
        }
    }
}