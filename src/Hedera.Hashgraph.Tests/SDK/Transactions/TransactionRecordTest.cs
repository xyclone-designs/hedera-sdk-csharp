    ...
    public class TransactionRecordTest
    {
        ...
        private static TransactionRecord SpawnRecordExample(ByteString? prngBytes, int? prngNumber)
        {
            return new TransactionRecord(
                ...
                "memo",
                3000,
                new ContractFunctionResult(new Proto.ContractFunctionResult
                {
                ...
                [new Transfer(AccountId.FromString("4.4.4"), Hbar.From(5))],

                // IDictionary<TokenId, IDictionary<AccountId, long>>
                new Dictionary<TokenId, IDictionary<AccountId, long>>
                {
                    { TokenId.FromString("6.6.6"), new Dictionary<AccountId, long> { { AccountId.FromString("1.1.1"), 4 } } }
                },
                [new TokenTransfer(TokenId.FromString("8.9.10"), AccountId.FromString("1.2.3"), 4, 3, true)],

                // IDictionary<TokenId, IList<TokenNftTransfer>>
                new Dictionary<TokenId, IList<TokenNftTransfer>>
                {
                    {
                ...
                [new TokenAssociation(TokenId.FromString("5.4.3"), AccountId.FromString("8.7.6"))],
                PrivateKey.FromStringECDSA("8776c6b831a1b61ac10dac0304a2843de4716f54b1919bb91a2685d0fe3f3048").GetPublicKey(),
                [],
                [],
                time,
                ByteString.CopyFrom(Encoding.UTF8.GetBytes("Some hash")),
                [new Transfer(AccountId.FromString("1.2.3"), Hbar.From(8))],
                prngBytes,
                prngNumber,
                ByteString.CopyFrom(Encoding.UTF8.GetBytes("0x00")),
                [
