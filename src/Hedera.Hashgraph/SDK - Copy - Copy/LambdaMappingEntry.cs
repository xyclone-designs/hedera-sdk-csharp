...
namespace Hedera.Hashgraph.SDK
{
    ...
    public class LambdaMappingEntry
    {
        ...
        public static LambdaMappingEntry FromProtobuf(Proto.LambdaMappingEntry proto)
        {
            ...
            {
                Proto.LambdaMappingEntry.EntryKeyOneofCase.Key => LambdaMappingEntry.OfKey(proto.Key.ToByteArray(), proto.Value.ToByteArray()),
				Proto.LambdaMappingEntry.EntryKeyOneofCase.Preimage => LambdaMappingEntry.WithPreimage(proto.Preimage.ToByteArray(), proto.Value.ToByteArray()),
                Proto.LambdaMappingEntry.EntryKeyOneofCase.None or _ => new ArgumentException("LambdaMappingEntry must have either key or preimage set")};
        }
