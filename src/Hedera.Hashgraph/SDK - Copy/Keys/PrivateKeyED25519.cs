...
namespace Hedera.Hashgraph.SDK.Keys
{
    ...
    class PrivateKeyED25519 : PrivateKey
    {
        ...
        PrivateKeyED25519(byte[] keyData, KeyParameter chainCode)
        {
            keyData = keyData;
            chainCode = chainCode;
        }
		...
		public static PrivateKey FromSeed(byte[] seed)
		{
			...
			hmacSha512.Init(new KeyParameter("ed25519 seed".Bytes(StandardCharsets.UTF_8)));
		...
		public override PrivateKey Derive(int index)
		{
			...
			hmacSha512.Update(keyData, 0, Ed25519.SecretKeySize);
