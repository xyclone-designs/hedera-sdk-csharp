...
namespace Hedera.Hashgraph.SDK
{
    ...
    public sealed class ScheduleInfo
    {
        ...
        public Transaction<TWildcardTodo> GetScheduledTransaction()
        {
