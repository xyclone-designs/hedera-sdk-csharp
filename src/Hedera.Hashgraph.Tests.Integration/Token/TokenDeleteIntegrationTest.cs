...
namespace Hedera.Hashgraph.Tests.Integration.Token
{
    ...
    {
        [Fact]
        /// <include file="TokenDeleteIntegrationTest.cs.xml" path='docs/member[@name="M:Hedera.Hashgraph.Tests.Integration.TokenDeleteIntegrationTest.CanDeleteToken"]' />
        ...
        [Fact]
        /// <include file="TokenDeleteIntegrationTest.cs.xml" path='docs/member[@name="M:Hedera.Hashgraph.Tests.Integration.TokenDeleteIntegrationTest.CanDeleteTokenWithOnlyAdminKeySet"]' />
        ...
        [Fact]
        /// <include file="TokenDeleteIntegrationTest.cs.xml" path='docs/member[@name="M:Hedera.Hashgraph.Tests.Integration.TokenDeleteIntegrationTest.CannotDeleteTokenWhenAdminKeyDoesNotSignTransaction"]' />
        ...
        [Fact]
        /// <include file="TokenDeleteIntegrationTest.cs.xml" path='docs/member[@name="M:Hedera.Hashgraph.Tests.Integration.TokenDeleteIntegrationTest.CannotDeleteTokenWhenTokenIDIsNotSet"]' />
