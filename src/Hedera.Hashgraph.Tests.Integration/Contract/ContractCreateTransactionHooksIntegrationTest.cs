...
{
    /// <include file="ContractCreateTransactionHooksIntegrationTest.cs.xml" path="docs/member[@name="T:Hedera.Hashgraph.SDK.Tests.Integration.ContractCreateTransactionHooksIntegrationTest"]" />
    public class ContractCreateTransactionHooksIntegrationTest
    {
        ...
        [Fact]
        /// <include file="ContractCreateTransactionHooksIntegrationTest.cs.xml" path="docs/member[@name="M:Hedera.Hashgraph.SDK.Tests.Integration.ContractCreateTransactionHooksIntegrationTest.ContractCreateWithBasicLambdaHookSucceeds"]" />
        ...
        [Fact]
        /// <include file="ContractCreateTransactionHooksIntegrationTest.cs.xml" path="docs/member[@name="M:Hedera.Hashgraph.SDK.Tests.Integration.ContractCreateTransactionHooksIntegrationTest.ContractCreateWithLambdaHookAndStorageUpdatesSucceeds"]" />
        ...
        [Fact]
        /// <include file="ContractCreateTransactionHooksIntegrationTest.cs.xml" path="docs/member[@name="M:Hedera.Hashgraph.SDK.Tests.Integration.ContractCreateTransactionHooksIntegrationTest.ContractCreateWithDuplicateHookIdsFailsPrecheck"]" />
        ...
        [Fact]
        /// <include file="ContractCreateTransactionHooksIntegrationTest.cs.xml" path="docs/member[@name="M:Hedera.Hashgraph.SDK.Tests.Integration.ContractCreateTransactionHooksIntegrationTest.ContractCreateWithLambdaHookAndAdminKeySucceeds"]" />
