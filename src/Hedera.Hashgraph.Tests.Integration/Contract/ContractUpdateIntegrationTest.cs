...
{
    /// <include file="ContractUpdateIntegrationTest.cs.xml" path="docs/member[@name="T:Hedera.Hashgraph.SDK.Tests.Integration.ContractUpdateIntegrationTest"]" />
	public class ContractUpdateIntegrationTest
	{
		...
		[Fact]
		/// <include file="ContractUpdateIntegrationTest.cs.xml" path="docs/member[@name="M:Hedera.Hashgraph.SDK.Tests.Integration.ContractUpdateIntegrationTest.CanUpdateContract"]" />
		...
		[Fact]
		/// <include file="ContractUpdateIntegrationTest.cs.xml" path="docs/member[@name="M:Hedera.Hashgraph.SDK.Tests.Integration.ContractUpdateIntegrationTest.CannotUpdateContractWhenContractIDIsNotSet"]" />
		...
		[Fact]
		/// <include file="ContractUpdateIntegrationTest.cs.xml" path="docs/member[@name="M:Hedera.Hashgraph.SDK.Tests.Integration.ContractUpdateIntegrationTest.CannotUpdateContractThatIsImmutable"]" />
        ...
        [Fact]
        /// <include file="ContractUpdateIntegrationTest.cs.xml" path="docs/member[@name="M:Hedera.Hashgraph.SDK.Tests.Integration.ContractUpdateIntegrationTest.SettingAutoRenewAccountIdToDefaultClearsField"]" />
