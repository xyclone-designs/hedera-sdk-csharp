...
namespace Hedera.Hashgraph.Tests.Integration
{
	...
	public class ContractUpdateIntegrationTest
	{
		...
		[Fact]
		/// <include file="ContractUpdateIntegrationTest.cs.xml" path='docs/member[@name="M:Hedera.Hashgraph.Tests.Integration.ContractUpdateIntegrationTest.CanUpdateContract"]' />
		...
		[Fact]
		/// <include file="ContractUpdateIntegrationTest.cs.xml" path='docs/member[@name="M:Hedera.Hashgraph.Tests.Integration.ContractUpdateIntegrationTest.CannotUpdateContractWhenContractIDIsNotSet"]' />
		...
		[Fact]
		/// <include file="ContractUpdateIntegrationTest.cs.xml" path='docs/member[@name="M:Hedera.Hashgraph.Tests.Integration.ContractUpdateIntegrationTest.CannotUpdateContractThatIsImmutable"]' />
        ...
        [Fact]
        /// <include file="ContractUpdateIntegrationTest.cs.xml" path='docs/member[@name="M:Hedera.Hashgraph.Tests.Integration.ContractUpdateIntegrationTest.SettingAutoRenewAccountIdToDefaultClearsField"]' />
