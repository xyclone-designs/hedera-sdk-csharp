...
{
    /// <include file="ContractInfoIntegrationTest.cs.xml" path="docs/member[@name="T:Hedera.Hashgraph.SDK.Tests.Integration.ContractInfoIntegrationTest"]" />
    public class ContractInfoIntegrationTest
    {
        ...
        [Fact]
        /// <include file="ContractInfoIntegrationTest.cs.xml" path="docs/member[@name="M:Hedera.Hashgraph.SDK.Tests.Integration.ContractInfoIntegrationTest.CanQueryContractInfo"]" />
        ...
        [Fact]
        /// <include file="ContractInfoIntegrationTest.cs.xml" path="docs/member[@name="M:Hedera.Hashgraph.SDK.Tests.Integration.ContractInfoIntegrationTest.CanQueryContractInfoWhenAdminKeyIsNull"]" />
        ...
        [Fact]
        /// <include file="ContractInfoIntegrationTest.cs.xml" path="docs/member[@name="M:Hedera.Hashgraph.SDK.Tests.Integration.ContractInfoIntegrationTest.CannotQueryContractInfoWhenContractIDIsNotSet"]" />
        ...
        [Fact]
        /// <include file="ContractInfoIntegrationTest.cs.xml" path="docs/member[@name="M:Hedera.Hashgraph.SDK.Tests.Integration.ContractInfoIntegrationTest.GetCostBigMaxContractInfoFunction"]" />
        ...
        [Fact]
        /// <include file="ContractInfoIntegrationTest.cs.xml" path="docs/member[@name="M:Hedera.Hashgraph.SDK.Tests.Integration.ContractInfoIntegrationTest.GetCostSmallMaxContractInfoFunction"]" />
        ...
        [Fact]
        /// <include file="ContractInfoIntegrationTest.cs.xml" path="docs/member[@name="M:Hedera.Hashgraph.SDK.Tests.Integration.ContractInfoIntegrationTest.GetCostInsufficientTxFeeContractInfoFunction"]" />
