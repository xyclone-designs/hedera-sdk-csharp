...
{
    /// <include file="NodeCreateTransactionIntegrationTest.cs.xml" path="docs/member[@name="T:Hedera.Hashgraph.SDK.Tests.Integration.NodeCreateTransactionIntegrationTest"]" />
    public class NodeCreateTransactionIntegrationTest
    {
        ...
        [Fact]
        /// <include file="NodeCreateTransactionIntegrationTest.cs.xml" path="docs/member[@name="M:Hedera.Hashgraph.SDK.Tests.Integration.NodeCreateTransactionIntegrationTest.CanCreateNewNetworkNode"]" />
