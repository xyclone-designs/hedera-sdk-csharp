...
namespace Hedera.Hashgraph.Tests.Integration.Networking
{
    ...
    public class NodeCreateTransactionIntegrationTest
    {
        ...
        [Fact]
        /// <include file="NodeCreateTransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hedera.Hashgraph.Tests.Integration.NodeCreateTransactionIntegrationTest.CanCreateNewNetworkNode"]' />
